...
import com.example.jony.myapp.reader_APP.ui.fragment.ReadingTabFragment;
...
public class ReadingDetailsActivity extends SwipeBackActivity implements SensorEventListener {
    ...
    private void  initData(){
        ...
        bookBean = (BookBean) getIntent().getSerializableExtra(getString(R.string.reader_id_book));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_ebook:
                ...
                intent.putExtra(getString(R.string.reader_id_url),ReadingApi.readEBook+Utils.RegexFind("/[0-9]+/",bookBean.getEbook_url()));
